...
public class SimilarityTableTest {
    ...
    public void setUp() {
        ...
        // Inicializamos las instancias de SimilarityTable con diferentes constructores
        similarityTableWithMatrix = new SimilarityTable(1, fastIndexes, relationMatrix);
