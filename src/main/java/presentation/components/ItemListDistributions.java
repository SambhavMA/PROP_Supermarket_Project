...
public class ItemListDistributions extends JPanel {
    ...
    public ItemListDistributions(ViewPrimary viewPrimary, int glRow, int glColumn, String[] columnsTitles, Component[][] data) {
        ...
        for (int row = 0; row < rows; row++) {
            ...
            rowPanel.addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    ...
                    // Creates a new view
                    viewPrimary.transitionContentPanel(viewPrimary.getDistributionPanel());
                }
